...
public class ErrorMenorValor extends ErrorValidacion {
    ...
    public ErrorMenorValor(Double precioTotalEgreso, Double precioTotalMenorPresupuesto) {
        ...
        this.mensaje = "No se eligio el presupuesto de menor valor. El egreso registrado tiene un precio total de "+precioTotalEgreso+" y el presupuesto de menor valor tiene un precio total de " + precioTotalMenorPresupuesto;
    }
